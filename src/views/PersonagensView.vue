    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      <div class="md:col-span-1 p-4 rounded-lg shadow bg-white dark:bg-slate-800 max-h-[600px] overflow-y-auto">
        ...
        <ul v-else class="space-y-1">
          <li v-for="personagem in personagensStore.personagens" :key="personagem.id"
      ...
      <div id="personagem-details" class="md:col-span-2 bg-white dark:bg-slate-800 p-6 rounded-lg shadow min-h-[400px]">
        <div v-if="selectedPersonagem" class="flex flex-col sm:flex-row gap-6 items-start">
          ...
          <div class="flex-grow">
            ...
            <p class="text-sm text-slate-600 dark:text-slate-400 mb-4">{{ selectedPersonagem.archetype }} • {{ selectedPersonagem.pontos }} pontos</p>
            <div class="mb-4">
...
onMounted(async () => {
  ...
  if (personagensStore.personagens.length > 0) {
    selectedPersonagem.value = personagensStore.personagens[0];
  }
});
